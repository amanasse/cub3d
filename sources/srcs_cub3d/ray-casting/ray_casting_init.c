...
/*   Updated: 2023/01/04 17:52:20 by mede-sou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (d->tab[(int)d->p_y][(int)d->p_x] == 'S')
	{
		d->ray.dir_y = 1.0;
		d->ray.plan_x = 0.66;
	}
	else if (d->tab[(int)d->p_y][(int)d->p_x] == 'N')
	{
		d->ray.dir_y = -1.0;
		d->ray.plan_x = -0.66;
	}
...
void	init_vectors(t_data *d)
{
	...
	d->pos_y = d->p_y + 0.5;
	init_vectors_n_s(d);
	if (d->tab[(int)d->p_y][(int)d->p_x] == 'W')
	{
		d->ray.dir_x = -1.0;
		d->ray.plan_y = 0.66;
	}
	else if (d->tab[(int)d->p_y][(int)d->p_x] == 'E')
	{
		d->ray.dir_x = 1.0;
		d->ray.plan_y = -0.66;
	}
